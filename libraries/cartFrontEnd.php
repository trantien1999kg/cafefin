<?php
    ...
    class cartFrontEnd{
        ...
        public function getPrice($pid){
            ...
            $sql = "select mucgia from #_baiviet where id='".$pid."'";
        ...
        public function getProductImg($pid,$lang,$url,$config_url,$size){
            ...
            $sql = "select photo, ten_$lang as ten from #_baiviet where id='".$pid."'";
        ...
        public function getProduct($pid){
            ...
            $sql = "select * from #_baiviet where id='".$pid."'";
        ...
        public function getProductName($pid,$field){
            ...
            $sql = "select $field from #_baiviet where id='".$pid."'";
                    ...
                    <div class="tr d-flex align-items-center">
                        ...
                        <div class="td item col-10">
                            ...
                            <label class="checker all">
                                ...
                                <span class="label">'._all.'(<span id="total-product">'.$result["total-product"].'</span> '._sanpham.')</span>
