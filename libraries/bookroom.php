...
class bookingRoom{
        ...
        public function getMans(){
            ...
            if($_GET['loai']==1){
                ...
                if($_GET['room_status']!='' && $_GET['room_status']!=0){

                    $trangthai = $_GET['room_status'];	
        ...
        public function deleteMan(){
            ...
            if(isset($_GET['id'])){
                ...
                if($item){
                    ...
                    $items  =  $this->_d->rawQuery("select id from #_bookroom where id=?",array($id));

                    if($items){

                        $this->_d->where('id', $id);

                        $this->_d->delete('bookroom');

                    }

                    $items_r  =  $this->_d->rawQuery("select id from #_bookroom where id=?",array($id));
