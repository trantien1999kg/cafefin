...
$popup= $db->rawQueryOne("select photo_$lang as photo , link_$lang as link , count from #_bannerqc where hienthi=1 and type=?",array('popup'));
...
<?php if($_SESSION['popup']< $popup['count']){?>
