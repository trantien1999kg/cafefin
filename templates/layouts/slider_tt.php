<?php
    ...
    $slider=$db->rawQuery("select ten_$lang,photo_$lang photo,link from #_photo where hienthi=1 and type=? order by stt asc,id desc",array('slider-tt'));

?>
<section id="slider-top" class="clearfix p-relatvie">
    <div class="maxSlider">
