    ...
    <div class="contact-main-page bg-white mt10 clearfix">
        ...
        <div class="wrapper-contact__aside-top mb20">
            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="item col-6 w-100-m d-flex">

                    <div class="contact__top-img d-flex flex-column">

                        <span class="d-block hover-left">

                            <img src="<?=_upload_hinhanh_l.$ha_lienhe->photo?>" alt="Hình ảnh liên hệ" <?=$func->errorImg()?>>
            ...
            <div class="row d-flex flex-wrap">
                ...
                <div class="item col-6 w-100-m w-100-t">
                    ...
                    <div class="contact-form-content pt-sm-55 pt-xs-55">
                        ...
                        <h3 class="contact-page-title mg-0 t-uppercase"><?=_guithudenchungtoi?></h3>
                            ...
                            <div class="row d-flex flex-wrap">
                                ...
                                <div class="item col-6 w-100-m">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="data[fullname]" class="css-input" id="customername" placeholder="<?=_hovaten?>">

                                    </div>

                                    <div class="form-group">

                                        <input type="email" name="data[email]" class="css-input" id="customerEmail" required placeholder="<?=_email?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="data[phone]" class="txt-input-number css-input" id="customerPhone"
                                            ...
                                            required placeholder="<?=_sodienthoai?>">
                                            ...
                                            <div class="row d-flex">
                                                ...
                                                <div class="item col-7">
                                                    ...
                                                    <input type="text" name="data[capcha]" class="capcha css-input" id="contactCapcha"
                                                        ...
                                                        required placeholder="<?=_mabaomat?>">
                                ...
                                <div class="item col-6 w-100-m">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="data[content]" id="contactMessage" class="css-input" placeholder="<?=_noidung?>"></textarea>
