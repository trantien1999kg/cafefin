...
<form name="supplier" class="form" action="index.html?com=setting&act=save" method="post" enctype="multipart/form-data"
    ...
    <div class="colLeft">
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                ...
                <div class="ck_editor">
                    ...
                    <textarea title="Nhập mô tả [<?=$v?>]. " data-height="400" id="mota_<?=$k?>"
                        <?=($GLOBAL[$com]['mota-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>
            ...
            <?php if($GLOBAL[$com]['hotline_advance']==true) {?>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Hotline không được để trống"
                        type="text" value="<?=@$item['hotline_kinhdoanh']?>" name="data[hotline_kinhdoanh]"
                        title="Nhập hotline" class="tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Hotline không được để trống"
                        type="text" value="<?=@$item['hotline_kythuat']?>" name="data[hotline_kythuat]"
                        title="Nhập hotline" class="tipS" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <select name="data[slider_web]">
                        ...
                        <option value="1" <?php if($item['slider_web']==1) echo 'selected'; ?>>Dạng slider video upload
                            file
            ...
            <?php if($GLOBAL['setting']['checkvideo']==true) {?>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <select name="data[checkvideo]">

                        <option value="">Chọn dạng video cho web</option>

                        <option value="1" <?php if($item['checkvideo']==1) echo 'selected'; ?>>Dạng Video Youtube
                            file

                        </option>

                        <option value="2" <?php if($item['checkvideo']==2) echo 'selected'; ?>>Dạng Video Nhập
            ...
            <?php if($GLOBAL['setting']['youtube']==true) {?>

            <div class="formRow">

                <label>Links Video Slider</label>
            ...
            <?php if($GLOBAL['setting']['pinterest']==true) {?>

            <div class="formRow">

                <label>Links Pinterest</label>

                <div class="formRight">

                    <input type="text" value="<?=@$item['pinterest']?>" name="data[pinterest]" title="Links Pinterest"
                        class="tipS" />
            ...
            <?php if($GLOBAL['setting']['instagram']==true) {?>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input type="text" value="<?=@$item['instagram']?>" name="data[instagram]" title="Links Instagram"
                        class="tipS" />
    ...
    <div class="colRight">
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <label>Chọn màu phụ</label>

                <div class="formRight form-mausac">

                    <input type="text" name="data[color_phu]" value="<?=@$item['color_phu']?>" class="cp3" />
            ...
            <?php if($GLOBAL[$com]['page_bookroom']==true) {?>

            <div class="formRow">

                <label>Phân trang đặt phòng</label>

                <div class="formRight">

                    <input data-validation="required" data-validation-error-msg="Phân trang không được để trống"
                        type="text" name="data[page_bookroom]" title="Nhập số item sản phẩm" id="page_bookroom"
                        class="tipS" value="<?=@$item['page_bookroom']?>" />
            ...
            <?php if($GLOBAL[$com]['page_dichvu']==true) {?>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Phân trang không được để trống"
                        type="text" name="data[page_dichvu]" title="Nhập số item sản phẩm" id="page_dichvu" class="tipS"
                        value="<?=@$item['page_dichvu']?>" />
            ...
            <div class="formRow">
                ...
                <label for="check1"
                    style="float: left; display: inline-block; width: auto !important; margin-right: 10px;">Slider
                    video</label>

                <input type="checkbox" name="slider_video" style="float: left;margin-top:5px" id="check1" value="1"
                ...
                <div class="formRight">
                    ...
                    <div class="mt10 change-photo">
                        ...
                        <span style="color:blue;display:block;font-size:16px;" class="mt20"><span
                                style="color:#000;">Tên tệp video: </span> <?=@$item["photo"]?></span>
        ...
        <div class="formRow">
            <label>Hình đóng dấu : <span style="color:#f00">(max-width:385px-max-height:288px)</span></label>
