    ...
    <div class="control_frm">
        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a
                        href="index.html?com=tags&act=add<?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"><span><?=$table['title']?></span></a>
                ...
                <div class="widget mtop0">
                        ...
                        <div class="formRight">
                            ...
                            <div class="box-alias"
                                ...
                                <div class="alias-text-disabled">
                                    ...
                                    <b><?=$https_config?><?=(!empty($item['type'])) ? $item['type'] : $_GET["type"]?>/</b>
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[cano_<?=$k?>]" title="Nhập link canonical"
                                id="canonical_<?=$k?>" class="tipS" value="<?=@$item['cano_'.$k]?>" />
            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <select class="main_select"
                                onchange="onChangePage(this.value,'tags_cat','<?=$_GET['type']?>','id_cat','id_list')"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <select class="main_select"
                                onchange="onChangePage(this.value,'tags_item','<?=$_GET['type']?>','id_item','id_cat')"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <select class="main_select"
                                onchange="onChangePage(this.value,'tags_sub','<?=$_GET['type']?>','id_sub','id_item')"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <div class="mt10"><img src="<?=_upload_tags.$item['icon']?>" alt="NO PHOTO" width="100" />
                            </div>
                ...
                <div class="widget mtop10">
                    ...
                    <div class="formRow">
                        ...
                        <label>Cấu trúc schema:</label>

                        <div class="formRight">

                            <textarea rows="7" class="tipS input100" name="dataseo[schema]"
                                id="schema"><?=@$seoDB['schema']?></textarea>
