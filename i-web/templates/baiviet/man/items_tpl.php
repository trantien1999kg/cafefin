            ...
            <div class="title">
                ...
                <div class="timkiem">
                    ...
                    <?php if($GLOBAL[$com][$type]['item']==true){ ?>
                        ...
                        <select class="main_select" name="data[id_item]" id="id_item" onChange="window.location.href='index.html?com=<?=$_GET['com']?>&act=man&type=<?=$_GET['type']?>&id_list=<?=$_GET['id_list']?>&id_item='+this.value">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td style="width: 15%; text-align: center;">Hình Ảnh</td>

                            <?php } ?>

                            <td class="sortCol" style="width:40%">
                        ...
                        <tr>
                            ...
                            <td align="center" class="title_name_data">
                                ...
                                <a href="index.html?com=baiviet&act=edit<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                    ...
                                    <img class="img-list" src="<?=_upload_baiviet.$items[$i]['photo']?>" alt="" width="100">
                            ...
                            <td class="title_name_data">
                                ...
                                <div class="add-attr mt10">
                                    ...
                                    <?php if(!in_array($type,$viewArray)){
                                        $result=$db->rawQueryOne("select tenkhongdau_$lang as alias,ten_vi from table_baiviet_list where id='".$items[$i]['id_list']."' and type=?",array($type));
                                        ?>

                                    <a style="color:#37a000;font-size:12px"

                                        href="<?=$https_config.$func->getComAdmin($_GET["type"]).'/'.$items[$i]['tenkhongdau_'.$lang]?>" target="_blank"
                            ...
                            <?php if($GLOBAL[$com][$type]['item']==true){?>
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    */ ?>
                                     ...
                                     <select select-w data-view-item data-item-<?=$items[$i]['id']?> data-product="<?=$items[$i]['id']?>" class="main_select select-w" name="select_item" id="item">

                                        <option>Chọn dmc3</option>
