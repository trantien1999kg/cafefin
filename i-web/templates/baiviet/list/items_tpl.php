...
<div class="control_frm">
    ...
    <div class="bc">
        ...
        <ul id="breadcrumbs" class="breadcrumbs">
            ...
            <li><a
                    href="index.html?com=baiviet&act=man_list&tbl=<?=$_GET['tbl']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?>"><span>Quản
            ...
            <li class="current"><a href="#" onclick="return false;"><?=$GLOBAL_LEVEL1[$com][$type]['title']?></a></li>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <?php foreach($GLOBAL_LEVEL1[$com][$type]['status'] as $key => $value){ ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if(!empty($GLOBAL_LEVEL1[$com][$type]['status'])){ $arr_status=explode(',',$items[$i]['status']);?>

                        <?php foreach($GLOBAL_LEVEL1[$com][$type]['status'] as $k1 => $v1){?>

                        <td class="sortCol" align="center">

                            <label class="stardust-checkbox checkOnOff">

                                <input class="checker-status" data-table="<?=$com?>_list" data-type="<?=$type?>"
                                    data-id="<?=$items[$i]['id']?>"
                        ...
                        <td align="center">
                            ...
                            <label class="stardust-checkbox checkOnOff">
                                ...
                                <input class="stardust-checkbox__input" data-id="<?=$items[$i]['id']?>"
                                    data-table="table_baiviet_list" data-type="<?=$key?>" rel="<?=$items[$i][$key]?>"
