    ...
    <div class="<?=($GLOBAL[$com][$type]['full']==true) ? 'oneOne':'colLeft' ?>">
        <div class="widget mtop0">
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                ...
                <div class="formRight">
                    <input type="text" name="data[ten2_<?=$k?>]" title="Nhập tên danh mục" id="ten2_<?=$k?>"
                ...
                <div class="formRight">
                    <div class="box-seo">
                        ...
                        <h3 style="padding-top: 10px;font-size: 20px;line-height: 1.3;color: #1a0dab;margin-bottom: 0px;font-weight:500"
                            class="title_seo" id="title_seo_<?= $k?>">
                        ...
                        <p style="padding-top:10px;font-size:14px;line-height: 1.57;word-wrap: break-word;color: #6a6a6a;margin-bottom: 0px;"
                            class="description_seo" id="description_seo_<?= $k?>">
            ...
            <div class="formRow lang_hidden lang_<?=$k?>  <?= ($k==$config['lang-default'])?"active":""?>">
                ...
                <div class="formRight">
                    <input data-validation="required" data-validation-error-msg="Title không được để trống" type="text"
                        value="<?=@$seoDB['title_'.$k]?>" class="title_seo" id="title" name="dataseo[title_<?=$k?>]"
                        title="Nội dung thẻ meta Title dùng để SEO" class="tipS input100" data-lang="<?= $k?>" />
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k==$config['lang-default'])?"active":""?>">
                ...
                <div class="formRight">
                    <textarea data-validation="required" data-validation-error-msg="Description không được để trống"
                        rows="4" cols="" title="Nội dung thẻ meta Description dùng để SEO" class="tipS input100 description_seo" 
                        name="dataseo[description_<?=$k?>]"  id="description_<?= $k?>"  data-lang="<?= $k?>"><?=@$seoDB['description_'.$k]?></textarea>
                </div>
                <div class="clear"></div>
            </div>
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k==$config['lang-default'])?"active":""?>">
                <div class="formRight">
                    <input readonly="readonly" type="text" style="width:45px; margin-top:10px; text-align:center;"
                        name="des_char"  id="des_char_<?=$k?>" value="<?=@$item['des_char']?>" /> <?=_kytu?> <b>(Từ 160-300 ký
                        tự)</b>
                </div>
                <div class="clear"></div>
            </div>
