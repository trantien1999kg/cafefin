    ...
    <div class="oneOne">
        <div class="widget mtop0">
            ...
            <div class="oneOne mtop10">
               ...
               <?php
                    $city = $apiPlace->getPlaceId('id','place_city',$item['id_city'],"id, ten");
                            
                    $dist = $apiPlace->getPlaceId('id','place_dist',$item['id_dist'],"id, ten");
                    
                ?>
                <div class="formRow">
                    <label style="white-space: initial;"><?=_tinhthanh?>: <span
                            style="color: #999;"><?=$city['ten']?></span></label>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label style="white-space: initial;"><?=_quanhuyen?>: <span
                            style="color: #999;"><?=$dist['ten']?></span></label>
                    <div class="clear"></div>
