    ...
    <div class="mtop0">
        ...
        <div class="oneOne">
            <div class="widget mtop0">
                ...
                <?php if($GLOBAL[$com][$type]['ten2']==true){ ?>
                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                    <label><?=_tieude?>2 [<?=$v?>]</label>
                    <div class="formRight">
                        <input type="text" name="data[ten2_<?=$k?>]"
                            title="Nhập tên" id="ten2_<?=$k?>" class="tipS validate[required]"
                            value="<?=@$item['ten2_'.$k]?>" />
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="formRow lang_hidden lang_<?=$k?>  <?= ($k == 'vi') ? 'active': '' ?>">
                    ...
                    <div class="formRight">
                        <input data-validation="required" data-validation-allowing="jpg, png"
                            ...
                            type="file" id="file_<?=$k?>" name="file_<?=$k?>" />
                ...
                <?php if($GLOBAL[$com][$type]['number']==true){ ?>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <input type="text" name="data[number]" title="Nhập Mức giá" id="number" class="conso tipS"
                            value="<?=@$item['number']?>" />
                    </div>
                    <div class="clear"></div>
                ...
                <?php if($GLOBAL[$com][$type]['link_tag']==true){ ?>

                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">

                    <label>Link tag [<?=$v?>]</label>

                    <div class="formRight">

                        <input type="text" name="data[linktag_<?=$k?>]" title="Nhập mã sản phẩm" id="linktag_<?=$k?>"
                            class="tipS" value="<?=@$item['linktag_'.$k]?>" />
                ...
                <div class="formRow">
                    <div class="formRight">
                        ...
                        <input type="text" class="tipS"
                            ...
                            onkeypress="return OnlyNumber(event)" original-title="Số thứ tự của danh mục, chỉ nhập số">
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
