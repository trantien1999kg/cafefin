<?php  if(!defined('_source')) die("Error");
    ...
    $per_page=$row_setting['page_album'];
     ...
     if($type=='web-mau'){
        ...
        $per_page= $deviceType!='phone' ? $row_setting['page_album'] : 4;
    ...
    if(!empty($idl)){
        ...
        if($row_list){
            ...
            if($com=='dat-phong'){
                ...
                $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 and type=? $order_by limit $startpoint,$page_bookroom",array($type));
