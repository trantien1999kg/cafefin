<?php 
    ...
    $limit = ' limit '.$startpoint.','.$per_page;
  	...
  	$sql = "SELECT *,tenkhongdau_$lang as tenkhongdau from #_baiviet where type in ('bat-dong-san','sang-nhuong','cho-thue','du-an') and hienthi=1 $where $order_by ".$limit;
    ...
    $sqlq = "SELECT COUNT(*) as `numb` from #_baiviet where type in ('bat-dong-san','sang-nhuong','cho-thue','du-an') and hienthi=1 $where $order_by";
